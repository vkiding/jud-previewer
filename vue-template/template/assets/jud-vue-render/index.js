console.log('START JUD VUE RENDER: 0.11.2, Build 2017-03-28 15:22.');
...
var env = {
  platform: 'Web',
  // judVersion: '0.10.0', // TODO: get version from package.json (not sure)
  judVersion: '0.11.2',
  userAgent: navigator.userAgent,
  appName: lib$1.env.jdApp ? lib$1.env.jdApp.appname : navigator.appName,
  appVersion: lib$1.env.jdApp ? lib$1.env.jdApp.version.val : null,
...
var warned = false;
var notePage = 'https://github.com/MrRaindrop/jud/issues/14';
    ...
    $processStyle: function $processStyle (style) {
      ...
      if (style.display === 'flex') {
        this.$nextTick(function () {
          if (this$1.$el) {
            this$1.$el.classList.add('jud-flex-ct');
          }
        });
      }
